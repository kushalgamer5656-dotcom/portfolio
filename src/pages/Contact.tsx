         ...
         <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
               <div className="relative">
                  ...
                  <div className="relative bg-black rounded-2xl p-2">
                     ...
                     <img
                        src={profileImage}
                        alt="Kushal Khanal"
                        className="w-full h-96 object-cover rounded-xl shadow-[0_0_30px_rgba(0,240,255,0.2)] border border-white/10"
                     />
               ...
               <div className="grid gap-4">
                  ...
                  <a href="https://www.linkedin.com/in/kushal-khanal-499093394/" target="_blank" rel="noreferrer" className="flex items-center gap-4 p-4 bg-white/5 hover:bg-white/10 border border-gray-800 hover:border-blue-500 transition-all rounded-lg group">
                     <div className="p-3 bg-gray-900 rounded-full group-hover:text-blue-500 text-gray-400 transition-colors">
                  ...
                  <a href="https://github.com/kushalgamer5656-dotcom" target="_blank" rel="noreferrer" className="flex items-center gap-4 p-4 bg-white/5 hover:bg-white/10 border border-gray-800 hover:border-white transition-all rounded-lg group">
                     <div className="p-3 bg-gray-900 rounded-full group-hover:text-white text-gray-400 transition-colors">
                        <Send className="w-6 h-6" />
                     </div>
                     <div>
                        <p className="text-sm text-gray-400">GitHub</p>
                        <p className="text-white font-medium">kushalgamer5656-dotcom</p>
                     </div>
                  </a>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-white/5 border border-gray-800 rounded-lg">
                     ...
                     <div>
                        ...
                        <p className="text-white font-medium">Kirtipur, Kathmandu</p>
                     </div>
                  </div>
               </div>
            </div>
